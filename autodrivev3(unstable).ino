...
void loop() {
  ...
  if (cm > stoppingDistance && cm < 30) {
    ...
    /* delay((cm-20)/calibratedSpeed*1000/2);  */
    delay(250);
    applyMotorControl(0, 0); 
  }
  else if (cm > 30) {
